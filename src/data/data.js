...
export const gradientsStatus = [
    {status: 'bronze', asset: 'linear-gradient(139.07deg, #832A00 15.05%, #643700 54.46%, #A24900 89.44%)'},
    {status: 'silver', asset: 'linear-gradient(139.07deg, #D0631C 15.05%, #AE460B 54.46%, #FDC08D 92.26%)'},
    {status: 'gold', asset: 'linear-gradient(139.07deg, #918F8B 15.05%, #575554 54.46%, #9F9D9D 92.26%)'},
    {status: 'platinum', asset: 'linear-gradient(139.07deg, #E3C559 15.05%, #C08F0F 54.46%, #E5BE30 92.26%)'},
    {status: 'vip', asset: 'linear-gradient(139.07deg, #151010 15.05%, #373633 54.46%, #212121 92.26%)'},
    {status: 'manager', asset: 'linear-gradient(139.07deg, #408DD5 15.05%, #0F41C0 54.46%, #147BDB 92.26%)'}
]